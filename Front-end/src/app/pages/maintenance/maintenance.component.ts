  ...
  onSearch() {
    ...
    if (this.searchQuery.trim() === '') {
      ...
      this.displayParts = this.dataParts.filter((part: any) =>
        (part.description && part.description.toLowerCase().includes(this.searchQuery.toLowerCase())) ||
        (part.part_number && part.part_number.toString().toLowerCase().includes(this.searchQuery.toLowerCase()))
      );
      this.calculateTotalPages();
    }
  }
