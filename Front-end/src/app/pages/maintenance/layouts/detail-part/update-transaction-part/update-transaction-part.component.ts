...
@Component({
  selector: 'app-update-transaction-part',
  templateUrl: './update-transaction-part.component.html',
  styleUrls: ['./update-transaction-part.component.scss']
})
export class UpdateTransactionPartComponent {
 // bread crumb items
